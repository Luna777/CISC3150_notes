...
all the data type in java is signed.
------------
in c/c++, int x=y=z=1
but in java, that will make a mistake.
------------
boolean bool= 20%2==0; //this is ok, 但最好不要这样写
    // 这里先计算 (20%2==0) is true, 然后bool is set to true
-------------
